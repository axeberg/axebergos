...
A mini-OS written in Rust, compiled to WebAssembly, running entirely in your browser.

**Disclaimer**: This is more or less fully generated by Anthropic's LLM "Opus" (v4.5) and is only for exploration purposes. Therefore, and this should go without saying: USE AT YOUR OWN RISK.
